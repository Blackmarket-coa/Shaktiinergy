...
import heroPhoto from '@/public/images/hero/malinda-sound-bath.jpg'
    ...
    <section className="hero" id="top">
      <div className="container hero-grid">
        <div className="hero-copy">
          <div className="eyebrow">Holistic Life &amp; Wellness Coaching — Columbia, SC</div>
        ...
        {/* priority: this is the LCP image on most viewports. */}
        <Image
          className="hero-photo"
          src={heroPhoto}
          alt="Malinda D. Ellis seated among crystal singing bowls, leading a sound bath session"
